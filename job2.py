...
def notionfetchagent(state: State) -> State:
    prompt = "You are an assistant responsible for simply making a call to the notion client API, and then doing the following instructions on the returned data: Analyze the content from the user's Notion journal entry and identify core desires for spiritual and personal growth. Return a list of main themes that reflect the user's growth aspirations."
